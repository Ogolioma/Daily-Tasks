    ...
    await Task.insertMany([
      {
        ...
        points: 6,
        questions: [
          { question: "How much capital did Jude use? (write in words)", answer: "zero" },
          { question: "What's the most beautiful button on the platform?", answer: "withdraw" },
          {question: "Join multiple _________ networks?", answer: "survey"},
          {question: "Where could you literally make money on?", answer: "toilet"},
          {question: "What should you withdraw your cash like?", answer: "boss"},
          {question: "What power should you not underestimate?", answer: "multitasking"},
           { question: "What do Companies pay you for?", answer: "opinion" },
          ...
          {question: "How many hours blackout did His country have? (Please, write in words)", answer: "eight"},
          {question: "__________ want people who nuy stuff, and live interesting lives", answer: "companies"},
          ...
          {question: "If you're using a ________ keep it active until your payment is processed?", answer: "proxy"},
           { question: "What should you create to go from $50 to $500 per month?", answer: "routine" },
          ...
          {question: "What platform will the next video be about?", answer: "primeopinion"},
          {question: "What should you treat Top Surveys like?", answer: "job"}
        ]
      },
      {
        title: "Watch Video",
        ...
        points: 6,
        questions: [
          { question: "What does the team live for?", answer: "results" },
          ...
          {question: "What should you trust", answer: "processes"},
      ...
      },
      {
        ...
        questions: [
          ...
          {question: "What should you do if this video made you smile?", answer: "subscribe"},
          {question: "It's not about perfection, it's about _________?", answer: "progress"},
          {question: "How many times did you refresh your post hoping for new likes (please, write in words)?", answer: "twelve"},
          {question: "What would you first start to feel?", answer: "momentum"},
      ...
      },
      {
        ...
        questions: [
          ...
          {question: "What's the second thing you deserve?", answer: "freedom"},
          {question: "What's the first thing you deserve?", answer: "earn"},
          {question: "Daily tasks is literally paid ________?", answer: "scrolling"},
          {question: "What type of goal should you set?", answer: "personal"},
          ...
          {question: "The tasks are _________ so gram them first thing in the morning", answer: "limited"},
      ...
      },
      {
        ...
        questions: [
          ...
          {question: "What compounds like money?", answer: "momentum"},
